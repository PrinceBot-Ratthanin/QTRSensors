...
class QTRSensors
{
  public:
    ...
    ~QTRSensors();
    int _min_sensor_values[8];
	int _max_sensor_values[8];
    ...
    int readPosition(bool colorLine){
        return readline(colorLine);
    }
    int readPosition_sensor(bool colorLine,uint8_t numOfSensor,uint16_t value_S1,uint16_t value_S2,uint16_t value_S3,uint16_t value_S4,uint16_t value_S5,uint16_t value_S6,uint16_t value_S7,uint16_t value_S8){
        return readline_sensor(colorLine,numOfSensor,value_S1,value_S2,value_S3,value_S4,value_S5,value_S6,value_S7,value_S8);
    }
    void setSensorMax(uint16_t value_S1,uint16_t value_S2,uint16_t value_S3,uint16_t value_S4,uint16_t value_S5,uint16_t value_S6,uint16_t value_S7,uint16_t value_S8,uint8_t num_Sensor);
    void setSensorMin(uint16_t value_S1,uint16_t value_S2,uint16_t value_S3,uint16_t value_S4,uint16_t value_S5,uint16_t value_S6,uint16_t value_S7,uint16_t value_S8,uint8_t num_Sensor);
    void PID_Calculator(uint16_t QTR_input,float QTR_KP,float QTR_KD);
  ...
  private:
    ...
    int readline(bool colorLine);
    int readline_sensor(bool colorLine,uint8_t numOfSensor,int value_S1,int value_S2,int value_S3,int value_S4,int value_S5,int value_S6,int value_S7,int value_S8);
